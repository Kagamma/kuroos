...
rem @fpc -Fukernel\debug -Fukernel\rtl  -Fukernel\init -Fukernel\asm -Fukernel\bios -Fukernel\drivers -Fukernel\filesystem -Fukernel\tasks -Fukernel\gfx -Fukernel\interrupts -Fukernel\mm -Fukernel\vga -Fikernel\ -FUlibs\ -Aelf -n -O1 -OpPENTIUM -Si -Sc -Sg -Xd -CX -XXs -Rintel -Tlinux kernel/kernel.pas
@fpc -Fukernel\debug -Fukernel\rtl -Fukernel\init -Fukernel\wm -Fukernel\asm -Fukernel\bios -Fukernel\strings -Fukernel\drivers -Fukernel\filesystem -Fukernel\loader -Fukernel\tasks -Fukernel\console -Fukernel\gfx -Fukernel\interrupts -Fukernel\mm -Fukernel\vga -Fikernel\ -FUlibs\ -Aelf -Sg -Rintel -Tlinux kernel/kernel.pas

@echo link everything into kernel.obj...
@i386-linux-ld --gc-sections -s -Map=libs/kernel.map -Tkernel/linker.script -o libs/kernel.obj libs/apm.o libs/trace.o libs/stub.o libs/real.o libs/bios.o libs/kex.o libs/schedule.o libs/mutex.o libs/spinlock.o libs/consolecmd.o libs/fat.o libs/cdfs.o libs/filesystem.o libs/pmm.o libs/vmm.o libs/kheap.o libs/rtc.o libs/pic.o libs/ide.o libs/keyboard.o libs/mouse.o libs/vga.o libs/vbe.o libs/kurogl.o libs/int0x03.o libs/int0x0e.o libs/int0x61.o libs/int0x69.o libs/int0x71.o libs/console.o libs/gdt.o libs/idt.o libs/isr_irq.o libs/mboot.o libs/kernel.o libs/system.o libs/sysutils.o libs/ImageLoader.o libs/math.o libs/sysfonts.o libs/objects.o libs/kurowm.o
